...
import com.shipdoc.global.security.jwt.filter.CustomUsernamePwdAuthenticationFilter;
import com.shipdoc.global.security.jwt.filter.JwtAuthenticationFilter;
import com.shipdoc.global.security.jwt.handler.JwtLoginFailureHandler;
import com.shipdoc.global.security.jwt.handler.JwtLoginSuccessHandler;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests((requests) -> requests
				...
				.requestMatchers(HttpMethod.GET, "/api/reservation/check-all").permitAll() // 허용된 주소
